				...
				<div className='antialiased bg-transparent flex flex-col font-sans items-stretch justify-center lg:flex-row lg:items-center'>
					<div className='flex flex-col flex-grow items-stretch max-w-7xl min-w-md w-full lg:flex-row lg:overflow-hidden my-8'>
						...
						>
							...
							>
								<p className='text-sm md:text-base text-white text-justify'>
									The &quot;Growth&quot; of TEDxVITPune began in April 2015, as
									we aspired to put forth the best of all events with a mission
									to bring together brilliant minds competent in &quot;Spreading
									Ideas&quot;. With a 9 speaker line-up, the pilot event
									garnered attention all across Pune and was set to embark on a
									journey to seek inspiration from revolutionary ideas.
								</p>
							...
							>
								...
								{!pane0 && (
									<div className='lg:-rotate-90 absolute text-black heading uppercase text-2xl text-center lg:bottom-36 lg:-left-2 left-14'>
										2015
									</div>
								)}
								<div
						...
						>
							...
							>
								<p className='text-[0.75rem] lg:text-base text-white text-justify'>
									&quot;Courage is what drives us, and you never know what is
									waiting until you complete your journey and reach the
									destination.&quot; The fourth edition of TEDxVITPune was not
									simply an event, but an exquisite experience altogether.
									Powerful speakers, unprecedented ideas, and melodious
									musicians helped raise the bar to showcase what a TEDx
									experience truly feels like. The offline event took place in
									October 2018, with remarkable orators like Girish Narayandass,
									Sameer Agashe, Anusree Raha, Stefano Pele, and many others.
								</p>
								<button className='mt-4 heading text-sm md:text-base text-black tracking-wider border-black border-2 px-6 py-2 hover:bg-black hover:text-white transition-all'>
									<a
						...
						>
							...
							>
								<p className='text-[0.8rem] lg:text-base text-white text-justify'>
									Embracing the chaos and the unknown with open hearts, for it
									is through these experiences that we grow and discover the
									depths of our strength and resilience. The 7th edition of
									TEDxVITPune saw a phenomenal speaker lineup, including
									Swanandi Tikekar, Sandeep Godbole, Samar Nakhate, Suchitha
									Champak, Abhinav Kafare, Deepak Krishnan, Karan Arjun Singh,
									and Sonal Barmecha, spread their ideas on diverse topics.
								</p>
