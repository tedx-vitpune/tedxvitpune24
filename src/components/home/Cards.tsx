...
export default function Cards() {
  return (
    <div className="mt-12">
      <div className="max-w-6xl mx-auto py-12 lg:py-16 lg:flex lg:items-center lg:justify-between px-6 lg:px-0">
          ...
          <div className="mt-8 lg:mt-12 flex justify-end">
            <Link href="/about">
              <div className="bg-[#dd1313] h-12 w-12 rounded-full flex justify-center items-center cursor-pointer">
                <Image className="w-6 h-6" width={24} height={24} src="/rc.svg" alt="chevron-right" />
              </div>
            </Link>
          </div>
        </div>
